...
These two quantities differ only in the centring of $K$ and $L$, amounting to constant shifts in the respective feature spaces of $k$ and $l$. This difference has the consequence of quite drastically changing the types of dependency that each statistic is sensitive to.

\subsection{Directions for future research}

At present, no formal characterisation has been made of the cases in which the Lancaster statistic is more sensitive to dependence than 3-way HSIC. The 
