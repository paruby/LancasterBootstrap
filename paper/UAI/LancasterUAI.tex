...
where the commutativity of $\mathbb{E}_Z$ with the inner product in the penultimate line follows from the Bochner integrability of the quantity $\phi_X(X) - \mu_X$, which in turn follows from the conditions under which $\mu_X$ exists \citep{steinwart2008support}. It follows that $\mathbb{E}_{XY} \bar{C}_{XY} = 0$.
