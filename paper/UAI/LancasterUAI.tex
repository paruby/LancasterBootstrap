...
By \cite{sejdinovic2013kernel}, we can consider the mean embedding of this measure:
\begin{align}
...
The statistic $\| \hat \mu^{(Z)}_{L,2} \|^2$ is much easier to study under the non-\emph{i.i.d.} assumption than $\|\hat \mu_L\|^2$. Indeed, it can expressed as a V-statistic
\[ 
