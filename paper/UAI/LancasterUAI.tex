...
\subsection{Proof that quantiles converge}\label{supp:quantile-proof}
\begin{proof}(Theorem \ref{theorem:quantiles-converge})

By Theorem 3.1 in \cite{leucht2013dependent}, $nV_b$ converges in distribution to the null distribution of $nV(h,\mathcal{S}_n)$
\end{proof} 



\subsection{Proof of semi-consistency}\label{supp:consistent}
